...
::: {.callout-note}
This page describes extending the classic **Connections** pane, which is being superseded by the new [Data Connections](data-connections.qmd) experience.
:::
...
For Python, Positron does not support an external extension mechanism. The **Connections** pane can be extended by implementing
