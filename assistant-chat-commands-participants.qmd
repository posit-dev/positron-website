...
This file demonstrates key features of custom prompts in Positron Assistant. It includes header fields like description, name, agent, tools, and argument-hint to configure behavior and guide users. The prompt body uses an input variable (${input:filePath}) to accept dynamic user input, making it reusable across different datasets. By specifying the agent mode and restricting what tools are available, the prompt tailors Assistant's behavior to exactly what's at hand.
