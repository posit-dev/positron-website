...
To view your data table, click the **View Data Table** ![](images/view-data-tables-button.png){width=22px} button to open the [Data Explorer](data-explorer.qmd) with the table loaded.
