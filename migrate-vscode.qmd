...
If you skip this step, you can import settings at any time by opening the Command Palette ({{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}}) and running the command *Preferences: Import Settings...*.
