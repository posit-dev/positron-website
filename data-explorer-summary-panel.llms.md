...
Get instant column statistics and visualizations with Data Explorer’s Summary Panel. View histograms, missing data, and detailed stats for every column.
...
[![Column arr_delay expanded in the summary panel. There is a bar with 2 percent, depicting how much data is missing. There is a graph of arrival delays showing a right skew. Summary statistics are displayed: 8,824 missing, --86 min, --5 median, 6.96 mean, 1,127 max, 44.98 SD.](images/data-explorer-summary-panel.png)](images/data-explorer-summary-panel.png "Data Explorer Summary Panel")
...
[![Summary panel showing flight data with columns like year, month, and day. A red progress bar loading indicator next to the column names shows the loading state. In the bottom status bar, a green loading indicator icon shows the loading status.](images/data-explorer-loading-indicators.png)](images/data-explorer-loading-indicators.png "Data Explorer Loading Indicators")
...
[![Sparkline Tooltip](images/data-explorer-summary-sparkline-tooltip.png)](images/data-explorer-summary-sparkline-tooltip.png "Sparkline Tooltip")

Sparkline Tooltip

[![Missing Data Tooltip](images/data-explorer-summary-missing-tooltip.png)](images/data-explorer-summary-missing-tooltip.png "Missing Data Tooltip")
...
[![Histogram showing data for air_time is highlighted, with a tooltip displaying a range of 121.3 to 129.7 and count of 13,239 (4.0%).](images/data-explorer-summary-data-type-tooltip.png)](images/data-explorer-summary-data-type-tooltip.png "Data Explorer Summary Data Type Tooltip")

Data Explorer Summary Data Type Tooltip

If the column has a label, the tooltip includes the label:

[![Hovering over column named 'age' in summary panel. Tooltip reads 'Age in years'](images/data-explorer-column-label-summary-panel.png)](images/data-explorer-column-label-summary-panel.png "Data Explorer Column Label")
...
[![Settings UI screenshot showing 'Data Explorer: Summary Collapsed' with an unchecked box, and 'Data Explorer: Summary Layout' dropdown set to 'left.'](images/data-explorer-summary-config.png)](images/data-explorer-summary-config.png "Data Explorer Summary Panel Configuration")
