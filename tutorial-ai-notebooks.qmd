...
::: {.callout-note}
Is this the right tutorial to start with? It picks up where [First data analysis with Python in a Jupyter Notebook](tutorial-get-started-ipynb.qmd) and [Migrate to Positron from VS Code](tutorial-migrate-from-vscode.qmd) leave off. If you have not worked through those, start there. This tutorial assumes you already know how to: 
...
![Positron's notification offering to create a virtual environment from requirements.txt](images/tutorial-python-ai-notification.png){fig-alt="The new Positron window displaying a notification in the bottom right corner."}
...
![The new virtual environment shown as the active interpreter in the interpreter picker](images/tutorial-python-ai-environment.png){fig-alt="Positron displaying the new environment as the active interpreter, shown in the interpreter picker in the top right."}
...
Posit Assistant is the AI assistant built into Positron. It does not include a language model of its own. Instead, it sends your prompt, along with context such as your open files and your session's data, to a language model provider that you choose and sign in to. The provider runs the model and returns the response, which Posit Assistant shows in the chat. You can open Posit Assistant by clicking its icon in the activity bar or by running _View: Show Posit Assistant_.

![Posit Assistant open in the left sidebar](images/tutorial-python-ai-assistant.png){fig-alt="Positron with Posit Assistant loaded in the left sidebar."}
...
![The Configure Language Model Providers window](images/tutorial-python-ai-configure-model.png){width=500 fig-alt="The Posit Assistant Configure Language Model Providers window."}

Because providers differ in what account and credentials they need, the steps below are deliberately general. Use whichever provider you already have access to. If you do not have one, [Posit AI Pass](assistant-providers.qmd#posit-ai) is the most direct way to get started. You can start a free trial at [posit.ai](https://posit.ai/) and sign in through your browser, with no API keys to manage.
...
::: {.callout-note}
For notebook work, we recommend an [Anthropic](assistant-providers.qmd#anthropic) model for the best experience. You can connect it directly, or reach Anthropic models through Posit AI Pass.
:::
...
![The quarterly sales chart you will ask Posit Assistant to build](images/tutorial-python-ai-chart.png){width=500 fig-alt="A bar chart showing quarterly sales over time, with a superimposed line chart."}
...
![Posit Assistant asking permission to run code](images/tutorial-python-ai-permission.png){width=400 fig-alt="A chat with Posit Assistant asking permission to run lines of code."}
...
![The interactive table and chart Posit Assistant generated](images/tutorial-python-ai-results.png){fig-alt="The Positron IDE showing a chart in the chat and a table in the viewer sidebar."}
...
![The exported notebook open in the Positron Notebook Editor](images/tutorial-python-ai-notebook.png){fig-alt="Positron in Notebook Layout mode with a notebook open."}
...
![The Notebook Assistant panel, showing context cells, quick actions, and suggestions](images/tutorial-python-ai-notebook-assistant.png){fig-alt="Notebook Assistant panel showing context cells, quick actions like Fix, Explain, and Improve, and AI-generated suggestions based on the notebook state."}
...
![Posit Assistant explaining a cell error](images/tutorial-python-ai-explain-error.png){width=600 fig-alt="A Posit Assistant chat that explains the cause of the error seen in the notebook beside it."}
...
![A ghost cell shown in grey with a dashed boundary](images/tutorial-python-ai-ghost-cell.png){width=500 fig-alt="A notebook that displays a ghost cell below a regular cell."}
...
![The Convert to .qmd item in the notebook menu](images/tutorial-python-ai-convert-to-qmd.png){width=500 fig-alt="The Convert to .qmd item highlighted in the menu of the notebook pane."}
