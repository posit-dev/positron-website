...
A notebook is a great place to work, but when you want to share results as a document, a Quarto report is a better container. It renders the same code and prose to HTML, PDF, Word, and more, so one source can become whatever format your audience needs.
