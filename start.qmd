...
Positron is a modern, extensible IDE for data science built on the open-source foundation of VS Code. It combines the power of a full-featured IDE with interactive data science tools for Python and R.
...
```{r}
#| echo: false
positronVersion <- params$version
```

[Download Positron for <span id="os-name">Your Platform</span>](#){.btn .btn-primary .disabled #download-btn data-version="`{r} positronVersion`"}
