...
Positron requires the IPykernel package (version 6.19.1 or higher) to communicate with Python. IPykernel is bundled with Positron for the CPython implementation, which is the default and most widely used Python implementation.

If you are using an implementation other than CPython, you'll need to install IPykernel manually in your Python environment. Positron prompts you to install IPykernel if it isn't found when you initially try to use a Python environment. Alternatively, you can add `ipykernel` to your package's existing requirements file, or install IPykernel manually as follows:
