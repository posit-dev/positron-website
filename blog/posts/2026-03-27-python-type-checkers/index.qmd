...
| Tool | Backing | Language | License | Stars[^1] |
|------|---------|----------|---------|:-----:|
...
**ty** is from Astral, the team behind uv and ruff. [OpenAI announced its acquisition of Astral](https://openai.com/index/openai-to-acquire-astral/) last week; Astral has stated that ty, ruff, and uv will remain open source and MIT-licensed. It's the newest project, with a focus on speed and tight integration with the Astral toolchain. It reached [beta status](https://github.com/astral-sh/ty/releases) in March 2026 and follows a "gradual guarantee" philosophy (more on that below).
...
**Basedpyright** and **Zuban** land somewhere in between, with Basedpyright leaning toward stricter checking and Zuban aiming for mypy compatibility.
...
- **Best overall UX for data science.** Hover docs were the cleanest. The type inference catches real bugs without requiring you to annotate everything, and the strictest type checking is off by default unless you configure it on. Notebook support has worked for months.
- **Active development with strong backing.** Meta has committed to making Pyrefly genuinely open-source and community-driven, with biweekly office hours and a public Discord. Development velocity is high.
- **MIT license.** No licensing complications for bundling.
...
Want to try Positron? [Download it here](/download.qmd). It's free and open source.
