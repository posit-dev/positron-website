...
---
::: {.callout-tip}
If you're currently reading this on our blog, consider subscribing to our [subscription page](https://posit.co/positron-updates-signup/) to receive this newsletter directly in your inbox.
:::
...
![A view from Point Lobos State Natural Reserve](images/monterrey.png)
...
- [What's Coming Next](#what's-coming-next): Inline Outputs, Packages Pane and Posit Assistant
...
We hosted a walkthrough of exploring GitHub data in a Jupyter Notebook and converting this into an interactive Shiny app with AI. [Catch up on the recording](https://www.youtube.com/watch?v=qrVkG89ndi8) or explore more Positron videos.
...
Ever wondered about the decision making process behind how we chose which Python type checker to bundle in Positron? Check out Austin Dickey's [blog post](../2026-03-31-python-type-checkers/index.html) walking through his research and decision making process.
