...
- **Title bar**: Located at the top, it shows the active file (_e.g.,_ `ui.rs`) along with window controls.
- **Top bar**: Provides global project tools such as file search, shows your active project (_e.g.,_ `ark`), and lets you change interpreter versions (e.g., `Python`, `R`).
