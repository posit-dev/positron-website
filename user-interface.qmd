...
This section outlines the core layout elements of Positron’s interface. Each pane plays a distinct role in supporting exploratory data analysis, reproducible authoring, and publishing data artifacts, giving you full control over your data science environment.

![Interface of the Positron development environment showing Title Bar, Top Bar, Primary Sidebar, central editor area, Secondary Sidebar, and Status Bar.](images/user-interface.png)  
...
- **Secondary sidebar**: The right panel, which displays panes like Session, [Connections](connections-pane.qmd), [Help](help-pane.qmd), Viewer, Variables, and Plots.
