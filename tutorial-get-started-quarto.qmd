...
description: "Set up an R environment, install packages, and explore data in a Quarto document in Positron."
...
![New Quarto Document in the New File dialog](images/new-quarto-document.png){fig-alt="New Quarto Document option in the New File dialog."}
...
![The starwars dataset in the Variables pane](images/variables-pane-starwars.png){fig-alt="Variables pane showing the starwars dataset variable."}
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-load-r.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-load-r-poster.jpg"
  aria-label="Opening a Quarto document in Positron and using the Data Explorer to generate code that filters the starwars dataset" >}}
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-explore-r.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-explore-r-poster.jpg"
  aria-label="Running ggplot2 visualization and summary table code in a Quarto document in Positron" >}}
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-render-r.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-render-r-poster.jpg"
  aria-label="Rendering and previewing a Quarto document as an HTML report in Positron" >}}
