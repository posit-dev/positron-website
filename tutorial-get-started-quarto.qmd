...
{{< video videos/tutorial-load-r.mp4 aria-label="Opening a Quarto document in Positron and using the Data Explorer to generate code that filters the starwars dataset" >}}
...
{{< video videos/tutorial-explore-r.mp4 aria-label="Running ggplot2 visualization and summary table code in a Quarto document in Positron" >}}
...
{{< video videos/tutorial-render-r.mp4 aria-label="Rendering and previewing a Quarto document as an HTML report in Positron" >}}
