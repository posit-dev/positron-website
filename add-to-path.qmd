...
description: "Launch Positron from your terminal by adding it to your PATH. Walk through step-by-step instructions for macOS, Windows, and Linux."
---
...
![Add Positron to your PATH](images/positron-path.png){width=600 fig-alt="Command Palette showing 'positron path' search with options to install or uninstall the positron command in PATH."}
