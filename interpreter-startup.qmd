...
description: "Control how Python and R interpreters start in Positron. Learn about automatic detection and workspace-based interpreter selection."
---
...
In the Settings UI, find the [`interpreters.startupBehavior`](positron://settings/interpreters.startupBehavior) setting without a language key, and choose the desired configuration. The selected startup behavior will be applied to _all_ interpreters.
