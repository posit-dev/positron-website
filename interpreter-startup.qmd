...
In the Settings UI, find the setting [`interpreters.startupBehavior`](positron://settings/interpreters.startupBehavior) without a language key, and choose the desired configuration. The selected startup behavior will be applied to _all_ interpreters.
