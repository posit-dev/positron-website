...
Positron currently provides initial debugging support via the [Debug Adapter Protocol](https://microsoft.github.io/debug-adapter-protocol/), including virtual document support for debugging package code. You can currently use:
...
:::{.callout-note}
Positron does not yet support debugging R code via visual breakpoints in `.R` files. [Follow along on GitHub for updates](https://github.com/posit-dev/positron/issues/1766) on breakpoints.
:::
