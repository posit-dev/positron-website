...
![](images/jupyter-notebooks-astropy.png)
...
You can manually select a different interpreter for the notebook by clicking the **Kernel Selector** button in the notebook toolbar or by running the _Notebook: Select Notebook Kernel_ command.
