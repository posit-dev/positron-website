...
If you prefer to keep your code in a plain script while still working interactively, you can divide a `.py` or `.R` file into [code cells](code-cells.qmd) and run it section by section.
