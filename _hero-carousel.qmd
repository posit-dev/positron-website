  ...
  <div class="pt-carousel__caption" id="pt-caption" aria-live="polite">
    <div class="pt-carousel__captionItem is-active">
      <div class="pt-carousel__captionText">
        ...
        <p class="pt-carousel__line">An AI assistant built for data science, it connects to your live Python or R sessions, sees your data, and helps you explore, visualize, build, and debug.</p>
      </div>
    ...
    <div class="pt-carousel__captionItem" hidden>
      <div class="pt-carousel__captionText">
        ...
        <p class="pt-carousel__line">Seamlessly pivot between the exploratory narrative of a notebook and the power of a persistent, multi-session Python or R console.</p>
      </div>
    ...
    <div class="pt-carousel__captionItem" hidden>
      <div class="pt-carousel__captionText">
        ...
        <p class="pt-carousel__line">Develop, generate, or preview local apps, APIs, notebooks, or reports, then publish with guided deployments.</p>
      </div>
