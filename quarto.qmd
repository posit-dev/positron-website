...
- _R: Render Document With R Markdown_ renders an `.Rmd` file using the R package [rmarkdown](https://pkgs.rstudio.com/rmarkdown/) instead of Quarto. This approach _does_ support all `.Rmd` features but does _not_ automatically preview the rendered output.
