...
You do not need to install Python before you begin. When you build your environment with uv in the steps below, Positron downloads a version of Python for you if you do not already have one. You can also install a version at any time from the Command Palette ({{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}}) by running _Python: Install Python via uv_.
:::
