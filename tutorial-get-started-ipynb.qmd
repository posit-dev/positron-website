...
description: "Set up a Python environment, install packages, and explore data in a Jupyter Notebook in Positron."
---
...
You do not need to install Python before you begin. When you build your environment with uv in the steps below, Positron downloads a version of Python for you if you don't already have one. You can also install a version at any time from the Command Palette ({{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}}) by running _Python: Install Python via uv_.
:::
...
2. Select a tool to build your environment. We recommend uv, but you can also use pip or conda. If you do not already have Python installed, choose uv. Positron will use uv to download a version of Python for you when it builds your environment.
...
4. Select a Python version to use for your environment. We recommend using the latest stable version of Python. If you built your environment with uv, you can pick any supported version (currently 3.9 through 3.14) and uv will download it for you if it is not already on your computer.
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-load-python.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-load-python-poster.jpg"
  aria-label="Setting up a new Python project in Positron, including creating a virtual environment and installing packages" >}}
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-filter-python.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-filter-python-poster.jpg"
  aria-label="Using the Positron Data Explorer to filter the mpg dataset and copy the generated filter code into a notebook cell" >}}
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-explore-python.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-explore-python-poster.jpg"
  aria-label="Building a plotnine chart and a summary table in a Jupyter Notebook, then adding a markdown title cell" >}}
...
{{< cdn-video https://cdn.posit.co/positron/releases/videos/tutorial-test-python.mp4
  poster="https://cdn.posit.co/positron/releases/videos/tutorial-test-python-poster.jpg"
  aria-label="Clearing outputs, restarting the kernel, and running all cells in a Jupyter Notebook in Positron" >}}
