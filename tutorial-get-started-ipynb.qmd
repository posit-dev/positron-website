...
![New Jupyter Notebook file](images/jupyter-notebook-option.png){width=700 fig-alt="Jupyter Notebook option in the New File dialog."}
...
![The mpg dataset in the Variables pane](images/variables-pane-mpg.png){width=700 fig-alt="Variables pane showing the mpg dataset variable."}
...
![Saving a notebook in Positron](images/save-notebook.png){width=700 fig-alt="Save button in the Jupyter Notebook toolbar."}
