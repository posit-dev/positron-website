...
* We currently only support Remote SSH and Posit Workbench features on RHEL 8/9/10 and Ubuntu 22/24. However, we plan to expand this set of Linux distributions in the future. Full Posit Team platform support is available on the [Posit Platform Support page](https://docs.posit.co/platform-support.html#positron-pro-sessions-in-workbench).
