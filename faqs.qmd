...
* Posit provides [free teaching licenses of Posit Workbench](https://posit.co/pricing/academic/), which includes Positron Pro for browser-based access by multiple users. In addition to Posit Workbench, when the functionality is available, we will permit qualified academic institutions to host Positron as a service for their currently enrolled students solely for educational purposes in connection with their coursework via a free teaching license.
