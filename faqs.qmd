...
* Under [Positron's Elastic license](https://positron.posit.co/licensing.html), you are free to use the software internally, modify it, and distribute it as part of internal workflows, whether for education or enterprise uses. This includes installing it on students' personal laptops, providing internal access via virtual desktop, internal lab deployments, or allowing access to internal HPC (High Performance Computing) clusters from Positron via Remote SSH.  
