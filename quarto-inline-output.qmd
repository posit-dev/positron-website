...
![A Quarto document in Positron with a Python code cell and its scatter plot of penguin measurements shown inline below the cell.](images/quarto-inline-output.png){width=500}
