...
The reticulate Python interpreter session is tied to the lifecycle of the R session. If you close the R session or restart it, the Python interpreter session will also be terminated. It's possible to restart the Python interpreter independently, but note that this **will not** restart the associated R session.
