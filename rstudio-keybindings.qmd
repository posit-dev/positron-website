...
* Mapping between shortcuts you’re used to in RStudio and equivalents in Positron
* Enabling RStudio shortcuts; list of supported RStudio shortcuts
* Creating your own shortcuts (does this belong in customization guide? is this really an RStudio migration topic or a more general documentation topic?)
