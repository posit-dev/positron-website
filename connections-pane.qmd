...
::: {.callout-note}
This page describes the classic **Connections** pane, which is being superseded by the new [Data Connections](data-connections.qmd) experience. We recommend starting there for new work.
:::
...
![Connections pane showing database schema, tables, and columns](images/connections-pane-schema-explorer.png){width=750 fig-alt="Connections pane schema explorer displaying database tables with expandable columns showing data types like VARCHAR, INTEGER, and DOUBLE."}
...
![Variables pane showing a connection object](images/connections-pane-variables-pane.png){width=400 fig-alt="Variables pane showing a conn variable with sqlite3.Connection type and a database icon button highlighted with a red square."}
