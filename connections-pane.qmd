...
![Variables pane showing a connection object](images/connections-pane-variables-pane.png){width=500 fig-alt="Variables pane showing a conn variable with sqlite3.Connection type and a database icon button highlighted with a red square."}
