...
![Diagram of the Positron IDE in Notebook layout showing the Posit Assistant chat pane to the left, the notebook editor in the center, and the Session pane with Variables to the right.](images/positron-notebook-layout.svg){.drop-shadow fig-alt="Stylized diagram of the Positron IDE with three main regions: the Posit Assistant chat pane on the left, the notebook editor in the center showing a code cell and a scatter plot, and the Session pane on the right listing variables in the active session."}
