...
![The Positron IDE in Notebook layout showing the Positron Assistant chat pane to the right, the notebook editor in the center, and the Variables Pane to the left.](images/positron-notebook-layout.png)
