...
:::{.callout-note}
We recommend opening the Command Palette with {{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}} and running the _View: Notebook Layout_ command for the best experience. This layout arranges the IDE panes into a notebook friendly setup.
:::
