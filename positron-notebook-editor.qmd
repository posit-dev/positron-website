...
2. Restart Positron, or open the Command Palette with {{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}} and run the _Developer: Reload Window_ command.
...
:::{.callout-note}
We recommend opening the Command Palette with {{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}} and running the **View: Notebook Layout** command for the best experience. This layout arranges the IDE panes into a notebook friendly setup.
:::

### Setting up your environment

Positron comes prepackaged with Jupyter kernels for R and Python. Once you've [configured a Python or R environment](managing-interpreters.qmd) for Positron, you do not need to install any additional dependencies into your environment before using a notebook.
...
2. [File issues](https://github.com/posit-dev/positron/issues) for any bugs or improvements you want to see. 
