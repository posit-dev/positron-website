...
![The Positron Notebook Editor action bar with the kernel selector highlighted, showing Python 3.10.20 as the selected interpreter.](images/positron-notebook-editor-kernel-selector.png){fig-alt="Notebook Editor action bar with the kernel selector dropdown highlighted in red, showing Python 3.10.20 (Venv: .venv) selected."}
