...
You can create and edit `.ipynb` files in Positron just as you would in other editors. To learn how to setup and use the Positron Notebook Editor, check out our [demo notebook](https://github.com/posit-dev/positron-demos-notebooks/).
