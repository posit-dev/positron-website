...
Your Positron experience can be customized through _settings_ at either the user or workspace level and by installing _extensions_.
...
- For comprehensive documentation on settings, visit the [VS Code settings documentation](https://code.visualstudio.com/docs/configure/settings). You can view and update your settings either via the Settings UI or by editing your `settings.json` file(s) directly.
...
Read more about [formatting R code with Air](migrate-rstudio-code.qmd).
