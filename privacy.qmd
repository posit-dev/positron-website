...
- To stop Positron checking for product updates, choose `none` for the setting [`update.mode`](positron://settings/update.mode).
- To stop Positron checking for extension updates, disable the setting [`extensions.autoCheckUpdates`](positron://settings/extensions.autoCheckUpdates).
...
- To stop Positron sharing the primary data science languages in use, disable the setting [`update.primaryLanguageReporting`](positron://settings/update.primaryLanguageReporting).
