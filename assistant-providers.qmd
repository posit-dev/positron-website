...
To change those entries, or to set the capability fields for each model, edit that block directly. See the [`providers.json` reference](https://assistant.posit.co/docs/reference/providers-config/) for how to choose which models appear.
