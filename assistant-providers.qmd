...
Please ensure you consult your provider's privacy policy and terms of service for information on the data they collect and how it is used. See the [Privacy & terms](assistant-provider-info.qmd) guide for more information.
...
## Posit AI Pass {#posit-ai}

Posit AI Pass (formerly Posit AI) is a hosted language model service from Posit, offering both chat models and code completions through [Next Edit Suggestions (NES)](assistant-completions.qmd#posit-ai-nes).
