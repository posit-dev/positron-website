...
1. Pick a **Provider Type**: **OpenAI Compatible**, **Anthropic**, or **OpenAI** ([more types are planned](https://github.com/posit-dev/positron/issues/15701)). The type decides the fields you fill in next, since a custom entry reuses that provider's own connection fields (for example, an Anthropic-type entry asks for the same API key as the built-in Anthropic provider).
...
## OpenAI Compatible [Experimental]{.provider-badge .experimental} {#openai-compatible}
