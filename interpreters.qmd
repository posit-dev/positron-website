...
The `interpreters.startupBehavior` setting controls how interpreters are started in Positron windows. By default, Positron will automatically try to start an interpreter when needed, or if it was previously used in the workspace.
