...
![Positron App Launcher button in Editor Actions](images/run-app-button.png){width=800 fig-alt="Editor action bar with the Play button highlighted in a red box, showing a Python Streamlit file open in the Editor."}
