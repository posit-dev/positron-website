...
3. Select the **Play** button drop-down context menu and choose **Debug [*{SUPPORTED_APP_TYPE}*] App in Terminal**.  
    - For this example, we select **Debug Steamlit App in Terminal**.

    ![Play button drop-down context menu](images/run-app-debug-streamlit.png){fig-alt="Play button dropdown menu showing options including Run Streamlit App in Terminal and Debug Streamlit App in Terminal."}
