...
Positron's extension API enables you to automate workflows, integrate specialized analysis tools, and create custom visualizations that leverage your running R or Python sessions directly.

Since Positron extensions add functionality on top of the VS Code extension API, this guide will omit many of the basic extension foundations. For these see [the VS Code extension documentation.](https://code.visualstudio.com/api/get-started/your-first-extension) 
