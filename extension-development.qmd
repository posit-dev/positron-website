...
These examples demonstrate deeper integrations with Positron's data science features:
...
You can ensure your extension runs on compatible Positron versions by adding a `positron` field to the `engines` section in your package.json:
...
- `2025.6.x` - Any patch version of 2025.6 (June 2025)
- `^2025.6.0` - Version 2025.6.0 or later
- `^2024.5.x` - Any version in the 2025.5 (May 2025) series or later
- `*` - Any version of Positron

::: {.callout-note}
Extensions without a `positron` field in `engines` are assumed compatible with any Positron version. This is to allow non-positron-aware extensions to still work. 
:::
...
- **Demo extension**: See more examples of the available API in the [demo extension](https://github.com/nstrayer/positron-extension-demo)
