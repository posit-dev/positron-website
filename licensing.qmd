...
Positron's license and third-party notices are available in your Positron installation's `Resources/app` folder. The same information is available on our GitHub repository at [LICENSE.txt](https://github.com/posit-dev/positron/blob/main/LICENSE.txt) and [ThirdPartyNotices.txt](https://github.com/posit-dev/positron/blob/main/ThirdPartyNotices.txt)
