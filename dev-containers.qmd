...
![Dev Containers experimental setting](./images/dev-containers-setting.png){width=578 fig-alt="The Dev Containers Enable setting checkbox, marked as Experimental"}
...
![Reopen in Container](./images/dev-containers-reopen.png){width=468 fig-alt="Notification prompting to reopen folder in a container with Reopen in Container button"}
...
![Remote Explorer](./images/dev-containers-remote-explorer.png){width=256 fig-alt="Remote Explorer view showing a list of running dev containers with action buttons"}
