...
Positron has preview support for [Development Containers](https://containers.dev/). This feature allows you to run your sessions inside ephemeral containers, giving you full control over the execution environment and encouraging reproducibility and isolation.
...
Dev containers are an **experimental** feature and must be manually enabled. Use the *Dev > Containers: Enable* setting to enable the feature.

![Dev Containers enablement setting](./images/dev-containers-setting.png){width=578}
...
![Dev Containers reopen notification](./images/dev-containers-reopen.png){width=468}
...
![Dev Containers remote explorer](./images/dev-containers-remote-explorer.png){width=256}
...
Positron's dev container's feature uses a subset of the commands and settings of those available in VS Code; read their guide [Developing inside a Container](https://code.visualstudio.com/docs/devcontainers/containers) for more information.
...
- musl-based Linux distributions (such as Alpine) [are not supported](https://github.com/posit-dev/positron/issues/10468); the container must be running a version of Linux already supported by Positron
