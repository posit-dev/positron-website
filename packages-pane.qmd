...
Entries also flag packages with known security vulnerabilities, with CVE (Common Vulnerabilities and Exposures) scoring from your environment's Posit Package Manager repository when it has one, and from the public Posit Package Manager instance otherwise.
