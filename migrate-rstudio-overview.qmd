...
* An integrated [data explorer](data-explorer.qmd) for a variety data files (CSV, Parquet, etc.) or for dataframes in your active R (or Python) sessions
* An [integrated AI assistant](assistant.qmd) that can "see" your active R (or Python) sessions
