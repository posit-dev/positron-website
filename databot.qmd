...
Databot was previously experimental and available in research preview, but is being deprecated in favor of [Posit Assistant](https://pos.it/assistant).

Posit Assistant is a new AI coding experience that brings together the capabilities of Positron Assistant and Databot into a unified experience. To learn how to enable it and get set up, visit the [Posit Assistant documentation](https://pos.it/assistant-docs).
...
![Databot Welcome Page](images/databot-welcome.png){width=500 fig-alt="Welcome page of Databot and suggested first actions to take, like checking loaded data or loading new data"}
...
First, make sure you have a recent version of Positron (2025.08.0 is the minimum version) and have enabled [Positron Assistant](assistant.qmd).

### Install the Databot extension

In Positron, choose the [Extensions view](extensions.qmd) from the Activity Bar on the left or use the keyboard shortcut {{< kbd mac=Command-Shift-X win=Ctrl-Shift-X linux=Ctrl-Shift-X >}} and search for "Databot". Select the button to install the extension.
...
To start Databot in another Positron session, open the Command Palette {{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}} and run _Open Databot_.
