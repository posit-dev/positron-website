...
Click on [the `databot.researchPreviewAcknowledgment` setting](positron://settings/databot.researchPreviewAcknowledgment) to open the acknowledgement. In the text box, type "Acknowledged".
