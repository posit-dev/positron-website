...
Databot is being deprecated in favor of [Posit Assistant](https://pos.it/assistant), a new AI coding experience currently available as a preview feature that brings together the capabilities of Positron Assistant and Databot into a unified experience. To learn how to enable it and get set up, visit the [Posit Assistant documentation](https://pos.it/assistant-docs).
...
::: {.callout-note}
Databot is **experimental** and available in research preview; it is not ready for production use.
:::
