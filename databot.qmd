...
![](images/databot-welcome.png){width=500 fig-align="center" fig-alt="Welcome page of Databot and suggested first actions to take, like checking loaded data or loading new data"}
...
Click on [the `databot.researchPreviewAcknowledgment` setting](positron://settings/databot.researchPreviewAcknowledgment) to open the **Research Preview Acknowledgement**. In the text box, type "Acknowledged".
