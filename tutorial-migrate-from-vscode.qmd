...
If you prefer the editor you know from VS Code, Positron still includes it as the [legacy notebook editor](jupyter-notebooks.qmd#legacy-notebook-editor), and you can switch between the two.
