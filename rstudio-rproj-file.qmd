...
This is such a wise and common practice, in data science and in software development more generally, that most integrated development environments (IDEs) have built-in support for this practice.

## The Rproj file in RStudio

In RStudio, you can designate the folder for a particular project (lowercase "p") as an RStudio Project (uppercase "P").
...
* Project Manager extension <https://open-vsx.org/extension/alefragnani/project-manager>. This is a VS Code extension that can be used with Positron by obtaining it from the Open VSX Registry.
...
* In the Project Manager area of Positron's Activity Bar, in the GIT area, go to "Open Settings" and configure base folders where you tend to keep your project folders.
  - The Project Manager extension workflow works best for users who keep all or most of their projects inside a small number of base folders. If this does not describe you, it might be a lifestyle worth adopting.
