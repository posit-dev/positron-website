...
description: "Understand how Positron handles RStudio files and project management. Learn about workspace settings and project organization."
aliases:
...
After installing Project Manager from the [extension gallery](extensions.qmd#extension-gallery), it appears as a stack of folders in the Activity Bar.
When selected, you gain access to a selectable, organized listing of your projects.
...
* Configure the extension to target Positron instead of VS Code:
  - In Raycast, enter enough to locate the "Search Project Manager" extension and select it. Select Actions in the lower right corner or press {{< kbd Cmd-K >}}. Go to Configure Extension or Configure Command.
...
Positron evolves quite rapidly, and if you are installing frequent updates, the Raycast "Search Project Manager" extension is prone to reverting back to launching VS Code.
