...
When using Positron's AI features, data including your prompts, responses and data usage may be shared with third-party AI model providers, such as Anthropic and GitHub Copilot, depending on the providers you use. Each provider has its own data handling, privacy policies, and terms of service.
