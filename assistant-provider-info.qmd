...
description: "Information about data handling, privacy, and terms of service for AI model providers used for Positron's AI features."
---
...
When using Positron's AI features (Posit Assistant, Positron Assistant, or Databot), data including your prompts, responses and data usage may be shared with third-party AI model providers, such as Anthropic and GitHub Copilot, depending on the providers you use. Each provider has its own data handling, privacy policies, and terms of service.
