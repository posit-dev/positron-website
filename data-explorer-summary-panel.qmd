...
![Data Explorer Column Label](images/data-explorer-column-label-summary-panel.png){fig-alt="Hovering over column named 'age' in summary panel. Tooltip reads 'Age in years'"}
