# 2025.11.0-234 Release Notes

<https://github.com/posit-dev/positron/releases/tag/2025.11.0-234>
...
- the command to connect to your remote machines
...
- \[[\#8393](https://github.com/posit-dev/positron/issues/8393)\] You can now paste or drop files as paths in R and Python scripts. You can copy files from a file manager and paste (or Shift then drop) into an R or Python file to automatically insert properly formatted, quoted file paths. Paths use forward slashes and are made relative when possible.
