...
- [[#15117](https://github.com/posit-dev/positron/issues/15117)] Assistant: added an _AI: Create Diagnostic Report_ command that collects AI settings, provider and model state, and recent AI logs into a single report for troubleshooting.
...
- [[#15031](https://github.com/posit-dev/positron/issues/15031)] Update notifications can now be muted, either from the gear menu on the notification or with the _Notifications: Toggle Do Not Disturb Mode By Source_ command.
