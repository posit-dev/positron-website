...
- [[#8188](https://github.com/posit-dev/positron/issues/8188)] The Plots pane no longer applies a theme-based filter by default; reenable the [`positron.plots.darkFilter` setting](positron://settings/positron.plots.darkFilter) if you prefer dark mode plots.
