# 2025.12.0-167 Release Notes

<https://github.com/posit-dev/positron/releases/tag/2025.12.0-167>
...
- \[[\#10346](https://github.com/posit-dev/positron/issues/10346)\] Assistant: added command *Positron Assistant: Reset State* to reset Assistant state.
- \[[\#10344](https://github.com/posit-dev/positron/issues/10344)\] Assistant: added command *Positron Assistant: Collect Diagnostics* to generate a diagnostics report.
...
- \[[\#7054](https://github.com/posit-dev/positron/issues/7054)\] Added new command *Plots: Open Plots Gallery in New Window* to open the whole Plots pane UI in an auxiliary window. You can also pop out the new standalone window from the plots action bar.
