...
```default
https://github.com/posit-dev/positron-quarto-workshop
```
...
::: {.callout-note}
Later in this tutorial you will also use code completions, which require [Posit AI](assistant-providers.qmd#posit-ai) or [GitHub Copilot](assistant-providers.qmd#github-copilot). Connecting one of those providers now lets you try that step when you reach it.
:::
