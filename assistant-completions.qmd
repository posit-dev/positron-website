...
- [Add Posit AI Pass as a language model provider](assistant-providers.qmd#posit-ai)
...
Posit AI NES is enabled by default once you have [signed in to the Posit AI Pass provider](assistant-providers.qmd#posit-ai). No additional setting changes are required.
...
- Sign out of Posit AI Pass in Positron via the Accounts menu or the _Accounts: Manage Accounts_ command. This also affects chat and other features that rely on the account.
...
- Run the _AI: Create Diagnostic Report_ command to see your providers, feature settings, and recent completions logs in one report. See [AI diagnostics](troubleshooting.qmd#ai-diagnostics).
