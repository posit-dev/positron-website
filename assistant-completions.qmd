...
Positron Assistant enables completions by default when you authenticate with **GitHub Copilot** as a language model provider.
...
![Assistant status bar icon](images/assistant-status-bar-icon.png)
