...
![Copying a Rectangular Range of Cells](images/data-explorer-copy-rectangular-range.png){fig-alt="Data grid showing a rectangular selection of cells highlighted in blue, spanning multiple rows and columns of numeric data." width=500}
...
![Copying Multiple Data Rows](images/data-explorer-copy-whole-rows.png){fig-alt="Data grid showing multiple entire rows selected and highlighted in blue, with row numbers visible on the left." width=500}

![Copying Multiple Data Columns](images/data-explorer-copy-whole-columns.png){fig-alt="Data grid showing multiple entire columns selected and highlighted in blue, with column headers visible at the top." width=500}
