...
![Data Explorer Grid Example](images/data-explorer-grid-example.png){.drop-shadow width=700 fig-alt="Data grid displaying flight data for January 1, 2013, with columns for year, month, day, dep_time, sched_dep_tim, and dep_delay."}
...
![Data Explorer Column Menu](images/data-explorer-column-menu.png){.drop-shadow width=300 fig-alt="Data explorer column dropdown menu open, showing options: Copy Column, Select Column, Pin Column, Sort Ascending, Sort Descending, Clear Sorting, and Add Filter."}
...
![Data Explorer Row Menu](images/data-explorer-row-menu.png){.drop-shadow width=300 fig-alt="Data explorer row right-click menu open, showing options: Copy Row, Select Row, and Pin Row."}
...
![Data Explorer Cell Value Tooltip](images/data-explorer-cell-value-tooltip.png){.drop-shadow width=280 fig-alt="Data explorer cell showing '2013-01-01 0...'. A highlighted row with an expanded view displays '2013-01-01 05:00:00.'"}
...
![Data Explorer Cell Menu](images/data-explorer-cell-menu.png){.drop-shadow width=300 fig-alt="Data explorer row right-click menu open, showing options: Copy, Select Column, Select Row, Pin Column, Pin Row, Sort Ascending, Sort Descending, Clear Sorting, and Add Filter."}
...
![Copying a Rectangular Range of Cells](images/data-explorer-copy-rectangular-range.png){.drop-shadow fig-alt="Data grid showing a rectangular selection of cells highlighted in blue, spanning multiple rows and columns of numeric data." width=550}
...
![Copying Multiple Data Rows](images/data-explorer-copy-whole-rows.png){.drop-shadow fig-alt="Data grid showing multiple entire rows selected and highlighted in blue, with row numbers visible on the left." width=600}

![Copying Multiple Data Columns](images/data-explorer-copy-whole-columns.png){.drop-shadow fig-alt="Data grid showing multiple entire columns selected and highlighted in blue, with column headers visible at the top." width=500}
