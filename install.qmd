...
In most cases Positron is ready to go as soon as it's installed. Check the sections below to see whether your platform or language setup needs anything more.
...
Positron runs without any programming language installed. If you plan to use R or Python, the steps below will get your environment working smoothly.
...
Ensure you have R 4.2 or higher installed. To install R, follow the instructions for your operating system at <https://cloud.r-project.org/>.
...
<div id="privacy-policy-agreement">
  ...
  <label for="privacy-checkbox">I agree to the <a href="licensing.qmd">Positron license agreement</a> and <a href="https://posit.co/about/privacy-policy/">Posit Privacy Policy</a>.</label>
</div>
:::
...
::: {#windows-buttons .hidden}
[Download for Windows (x64)](#){.btn .btn-primary .disabled #download-btn-win-x64 data-version="`{r} positronVersion`"}
[Download for Windows (arm64)](#){.btn .btn-secondary .disabled #download-btn-win-arm64 data-version="`{r} positronVersion`"}
:::

::: {#macos-buttons .hidden}
[Download for macOS (Apple Silicon)](#){.btn .btn-primary .disabled #download-btn-mac-arm data-version="`{r} positronVersion`"}
[Download for macOS (Intel)](#){.btn .btn-secondary .disabled #download-btn-mac-intel data-version="`{r} positronVersion`"}
:::
