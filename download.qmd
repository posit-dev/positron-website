...
urls <- list(
  glue("https://cdn.posit.co/positron/prereleases/win/x86_64/Positron-{params$version}-Setup.exe"),
  glue("https://cdn.posit.co/positron/prereleases/win/x86_64/Positron-{params$version}-UserSetup.exe"),
  glue("https://cdn.posit.co/positron/prereleases/mac/universal/Positron-{params$version}.dmg"),
  glue("https://cdn.posit.co/positron/prereleases/deb/x86_64/Positron-{params$version}.deb"),
  glue("https://cdn.posit.co/positron/prereleases/rpm/x86_64/Positron-{params$version}.rpm")
)
