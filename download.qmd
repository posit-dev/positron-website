...
<div id="privacy-policy-agreement">
  <input type="checkbox" id="privacy-checkbox" onclick="privacyClickHandler(this)">
  <label>I agree to the Positron license agreement and Posit Privacy Policy.</label>
</div>

```{r, id='download-table', class='hidden'}
#| echo: false
#| classes: plain
...
download_table <- data.frame(
  Platform = c(
    ...
    "Debian-based Linux x64 (Ubuntu 22+)",
    "Debian-based Linux arm64 (Ubuntu 24+)",
