...
<input type="checkbox" id="privacy-checkbox" onclick="updatePrivacy(this)"> <label>I agree to the [Positron license agreement](licensing.qmd) and [Posit Privacy Policy](https://posit.co/about/privacy-policy/).</label>
:::
::::
