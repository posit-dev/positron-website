...
# Create URLs
cdn_url <- "https://cdn.posit.co/positron/releases/"
windows_system <- glue("Positron-{release_version}-Setup.exe")
windows_user <- glue("Positron-{release_version}-UserSetup.exe")
macos_universal <- glue("Positron-{release_version}-universal-universal.dmg")
macos_arm64 <- glue("Positron-{params$version}-arm64.dmg")
macos_x64 <- glue("Positron-{params$version}-x64.dmg")
