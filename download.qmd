...
<input type="checkbox" id="privacy-checkbox" onclick="updatePrivacy(this)"> <label for="privacy-checkbox">I agree to the [Positron license agreement](licensing.qmd) and [Posit Privacy Policy](https://posit.co/about/privacy-policy/).</label>
:::
::::
...
urls <- list(
  glue("{cdn_url}win/x86_64/{windows_system_x64}"),
  glue("{cdn_url}win/x86_64/{windows_user_x64}"),
  glue("{cdn_url}win/arm64/{windows_system_arm64}"),
  glue("{cdn_url}win/arm64/{windows_user_arm64}"),
