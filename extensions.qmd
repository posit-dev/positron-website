...
Extensions can offer Positron powerful new capabilities in addition to the built-in data science experience. However, they can also present risks, similar to Python or R packages, such as malicious code execution or inappropriate data access. Third-party extensions can read or modify files, make network requests, and take other actions that could accidentally or maliciously result in a security issue. 
...
OpenVSX has several mechanisms in place to help protect users, including requiring membership within a [namespace to publish](https://github.com/eclipse/openvsx/wiki/Namespace-Access) and displaying a Verified Publisher badge for specific, verified namespaces.

For example, Posit’s Air extension displays the “Posit Software, PBC” Verified Publisher badge, and “Lionel”, the developer from Posit who published the extension.

![AIR extension as displayed in the Extensions pane of Positron](images/extension-verified-publisher.png)

You can vet an extension in a few different ways::
- **Verified Publisher**: The ☑️ badge indicates a Verified Publisher and access to that namespace.
...
![Modal prompt to confirm trust in that specific extension publisher](images/extension-publisher-trust.png)

OpenVSX will remove known malicious extensions and also make use of the extension blocklist from the VS Code marketplace. To report suspicious or questionable extensions, or report abuse, please reach out to OpenVSX via their [security portal](https://github.com/eclipse/openvsx/security) or via the “Report Abuse” button on the specific extension’s page of OpenVSX.
...
### Positron bundled extensions

Positron comes bundled with several extensions, both from Posit and external verified publishers. 

* Posit PBC extensions  
  * rstudio.rstudio-workbench - internal Posit Workbench extension, not open source
  * [posit.publisher](https://github.com/posit-dev/publisher)  
  * [quarto.quarto](https://github.com/quarto-dev/quarto/tree/main/apps/vscode)  
...
* Third Party Extensions  
  ...
  * [ms-toolsai.jupyter-renderers](https://github.com/Microsoft/vscode-notebook-renderers)  
  * [ms-toolsai.vscode-jupyter-cell-tags](https://github.com/Microsoft/vscode-jupyter-cell-tags)  
  * [ms-toolsai.jupyter-keymap](https://github.com/Microsoft/vscode-jupyter-keymap)  
  * [ms-toolsai.vscode-jupyter-slideshow](https://github.com/Microsoft/vscode-jupyter-slideshow)  
  * [ms-toolsai.jupyter](https://github.com/Microsoft/vscode-jupyter)  
  * [ms-pyright.pyright](https://github.com/Microsoft/pyright)  
  * [ms-python.debugpy](https://github.com/microsoft/vscode-python-debugger)  
