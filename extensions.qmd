...
- [posit.publisher](https://open-vsx.org/extension/posit/publisher): A publishing tool for deploying content to [Posit Connect](https://posit.co/products/enterprise/connect/) and [Posit Connect Cloud](https://connect.posit.cloud/). It streamlines the process of sharing data science applications, reports, and APIs with stakeholders. Explore the [publisher guide](publishing-to-connect.qmd)
