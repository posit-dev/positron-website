...
::: {.callout-note}
The _Positron Assistant: Collect Diagnostics_ command is only available in builds that still ship the Positron Assistant extension. On Positron 2026.08 and later, run _AI: Create Diagnostic Report_ instead. It covers all of the AI features in Positron, not only the chat and completions interfaces. See [AI diagnostics](troubleshooting.qmd#ai-diagnostics).
:::
