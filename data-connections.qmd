...
::: {.callout-important}
Data Connections is an experimental feature. Opt in via the [`dataConnections.enabled`](positron://settings/dataConnections.enabled) setting, and reload Positron to apply. Share your feedback on this new feature in the [Positron GitHub discussions](https://github.com/posit-dev/positron/discussions).
:::
