...
The command _Inline Chat: Editor Inline Chat_ (default keybinding: <kbd>Cmd + I</kbd>) will open a mini chat right in the editor. This is very useful for asking questions in context, and also includes a good UX for integrating changes suggested by the model.
