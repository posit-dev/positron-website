...
To learn more about the format of custom chat modes, see the following VS Code documentation:

- [Chat mode file structure](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_chat-mode-file-structure)
...
- [Prompt file format](https://code.visualstudio.com/docs/copilot/customization/prompt-files#_prompt-file-format)
    - Note: Positron Assistant does not support the `model` field at this time.
