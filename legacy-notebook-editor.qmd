...
![The Legacy Notebook Editor action bar with the kernel selector highlighted, showing Python 3.13.10 as the selected interpreter.](images/jupyter-notebooks-kernel-selector.png){fig-alt="Notebook Editor action bar with the kernel selector button highlighted, displaying Python 3.13.10 as the current kernel."}
