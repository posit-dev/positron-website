...
![Active interpreter session](images/active-interpreter-session.png){fig-alt="Positron IDE with a red square around the interpreter picker. R 4.5.2 is the active console session and is highlighted in the Console pane."}
