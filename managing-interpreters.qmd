...
The Interpreter picker lists every running interpreter session so you can see and switch between them from one place.
...
![Active interpreter session](images/active-interpreter-session.png){fig-alt="Positron IDE showing the active interpreter session R 4.5.0 highlighted in the interpreter picker and Console pane list with multiple interpreter options visible."}
