...
Posit does not track, collect, or store your prompts, code or conversations when using AI features within Positron (i.e. Assistant, Databot, etc) with third-party model providers. However, your AI model provider may collect data according to their own privacy policies and terms of service. Please review your provider’s data practices for details on what information they collect and how it’s used.
