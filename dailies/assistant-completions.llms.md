...
Boost your productivity with AI code suggestions via Posit AI Next Edit Suggestions or GitHub Copilot completions. Inline suggestions support faster coding in Python, R, and more.
...
| *Cancel Snooze Inline Suggestions* | Resume snoozed inline suggestions immediately. |
...
GitHub Copilot completions are enabled after you [sign in to the GitHub Copilot provider](assistant-providers.llms.md#github-copilot). No additional setting changes are required.
...
- Sign out of GitHub in Positron via the Accounts menu or the *Accounts: Manage Accounts* command. This also affects other features and extensions that rely on the GitHub account. Without a signed-in GitHub account, GitHub Copilot Chat cannot be used, and GitHub Copilot cannot provide completions, Next Edit Suggestions, or be used as a provider for Posit Assistant.
...
[![The Assistant status bar icon in the Positron status bar, showing the current state of GitHub Copilot completions.](images/assistant-status-bar-icon.png)](images/assistant-status-bar-icon.png "Assistant status bar icon")
