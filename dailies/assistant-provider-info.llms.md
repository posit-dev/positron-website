...
Posit AI Pass is a hosted service that Posit operates. See [posit.ai](https://posit.ai/) for its terms and privacy policy. Every other AI model provider you can connect in Positron is a third-party service, and that provider’s own terms of service and privacy policy govern your use of it.
...
However, your AI model provider may store or collect data according to their own privacy policies and terms of service. Please review your AI model provider’s data practices for details on what information they collect and how it is used.
