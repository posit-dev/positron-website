...
Deploy reports, apps, and APIs directly from Positron to Posit Connect or Posit Connect Cloud with one click, using the bundled Publisher extension.
...
The [Posit Publisher extension](https://open-vsx.org/extension/posit/publisher) comes pre-installed with Positron as a [bootstrapped extension](extensions.llms.md#bootstrapped-extension). This means it’s available by default when you start Positron and updates automatically when new versions are released.
