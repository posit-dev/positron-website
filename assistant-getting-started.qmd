...
Amazon Bedrock provider support is currently in preview and must be manually enabled. Opt in to the [`positron.assistant.provider.amazonBedrock.enable`](positron://settings/positron.assistant.provider.amazonBedrock.enable) setting to enable it.
...
Snowflake Cortex provider support is currently in preview and must be manually enabled. Opt in to the [`positron.assistant.provider.snowflakeCortex.enable`](positron://settings/positron.assistant.provider.snowflakeCortex.enable) setting to enable it.
...
OpenAI provider support is currently in preview and must be manually enabled. Opt in to the [`positron.assistant.provider.openAI.enable`](positron://settings/positron.assistant.provider.openAI.enable) setting to enable it.
...
Custom provider support is currently experimental and must be manually enabled. Opt in to the [`positron.assistant.provider.customProvider.enable`](positron://settings/positron.assistant.provider.customProvider.enable) setting to enable it.
