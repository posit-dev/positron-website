...
![Assistant Sidebar Icon](images/assistant-sidebar-icon.png)
...
To add a language model provider, use the following steps to sign in to your account for the provider and authorize Positron Assistant to access it. To remove a provider, sign out from your account in Positron Assistant.
...
1. Select **Anthropic** as the model provider.
    ![Anthropic selected in Provider modal](images/assistant-provider-modal-anthropic.png)
...
1. Select **GitHub Copilot** as the model provider.
    ![GitHub Copilot selected in Provider modal](images/assistant-provider-modal-github-copilot.png)
...
Once you've authenticated with at least one language model provider, you're all set to use Positron Assistant. Explore the core features to get started:
