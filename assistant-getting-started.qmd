...
::: {.callout-tip}
You can also sign in to GitHub via the {{< fa circle-user >}} **Accounts** icon in the sidebar. To sign out, use the Accounts icon or run the _Accounts: Manage Accounts_ command.
