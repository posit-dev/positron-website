...
Note that Remote SSH is *only* supported on the desktop app; it is not currently possible to use Remote SSH from Positron Pro sessions on Posit Workbench
