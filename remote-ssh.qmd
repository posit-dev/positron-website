...
To create a connection, open the Command Palette ({{< kbd mac=Command-Shift-P win=Ctrl-Shift-P linux=Ctrl-Shift-P >}}) and type "Remote Menu". Run the _Remote SSH: Show Remote Menu_ command.
