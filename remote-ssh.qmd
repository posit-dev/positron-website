...
The shutdown timeout will never interrupt a kernel that is busy running code; it does not start counting down until the kernel is  idle _and_ it is not connected to any Positron windows. 
