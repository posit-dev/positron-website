...
Start new projects with Folder Templates. Automated setup creates environments, version control, and project structure for Python, R, and more.
...
For more about environment managers, see the [supported environment managers guide](python-installations.llms.md#supported-environment-managers). For details about Python interpreter discovery, see the [Discovering Python Installations guide](python-installations.llms.md).
...
`renv` is an R package that manages project dependencies. It creates a snapshot of the R packages in your project and saves them in a `renv.lock` file. This is helpful for power users who need to share projects or ensure exact package versions. [Learn more about renv.](https://rstudio.github.io/renv/articles/renv.llms.md)
