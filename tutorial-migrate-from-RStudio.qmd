...
![Open the settings with _Preferences: Open Settings (UI)_.](images/tutorial-migrate-open-settings.png){fig-alt="The Command Palette displaying _Preferences: Open Settings (UI)_." width=500}

![Search the settings for `rstudioKeybindings` and click the box to enable RStudio keyboard shortcuts.](images/tutorial-migrate-open-keybindings.png){fig-alt="The Positron Settings file." width=500}
