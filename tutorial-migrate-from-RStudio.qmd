...
::: {.callout-note}
Prefer to learn the native Positron shortcuts? Leave this setting off. See [Positron keyboard shortcuts](keyboard-shortcuts.qmd) and [R-specific shortcuts](guide-r.qmd#keyboard-shortcuts) for the full reference, and remember you can always look up and change any command's shortcut in the Command Palette.
