---
title: "Action Bars"
description: "Discover how Positron's Action Bars put essential functionality at your fingertips with context-aware buttons, menus, and controls throughout the interface."
---

Positron uses Action Bars throughout the application to put essential functionality at your fingertips.

![Action Bars](images/action-bars.png){fig-alt="Positron IDE showing action bars in various panes including the Editor, Console, Variables pane, and Plots pane."}
...
![Action Bar Regions](images/action-bar-regions.png){width=700 fig-alt="An action bar divided into three labeled sections: left, center, and right."}
...
![Action Bar Tooltip](images/action-bar-tooltip.png){fig-alt="Action bar showing a tooltip that reads 'Restart Python' when hovering over the restart button."}
...
![Top Action Bar](images/top-action-bar.png){fig-alt="Annotated top action bar showing New File/Folder, Open File/Folder, Backward/Forward navigation, Command Center search, Interpreter Selector, and Folder Selector."}
