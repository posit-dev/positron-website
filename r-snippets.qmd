...
A snippet for `for` inserts this whole skeleton, with special placeholders that let you use "tab" to move through the positions for `variable`, `vector`, and `# code to repeat`.
