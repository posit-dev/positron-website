...
Create custom R code snippets in Positron. Speed up coding with ready-made templates for loops, functions, and common patterns.
...
A snippet for `for` inserts this whole skeleton, with special placeholders that let you use TabTab to move through the positions for `variable` and `vector`, and `# code to repeat`.

[![Completion list after typing “for”, showing the snippet that can be inserted](images/snippets-for-example.png)](images/snippets-for-example.png "Completion list after typing “for”, showing the snippet that can be inserted")
...
[![Completion list with rectangles highlighting two entries for the function reserved word, one as a bare keyword completion and another as a snippet](images/snippets-keyword-with-two-items.png)](images/snippets-keyword-with-two-items.png "Completion list with rectangles highlighting two entries for the function reserved word, one as a bare keyword completion and another as a snippet")
...
2.  “Global” but for one workspace: contains snippets for multiple languages but tied to a specific workspace. Create with *New Snippets file for ‘MyProject’*.
    ...
    [![Menu with options for “New Global Snippets file” and “New Snippets file for ‘MyProject’”](images/snippets-configure-snippets.png)](images/snippets-configure-snippets.png "Menu with options for “New Global Snippets file” and “New Snippets file for ‘MyProject’”")
...
3.  Language-specific: contains snippets for one specific language. Create by selecting the language from the drop-down menu, which includes entries for R, Python, and Quarto.
    ...
    [![Menu with options for creating a new snippet file for Python, Quarto, or R](images/snippets-configure-language-specific-snippets.png)](images/snippets-configure-language-specific-snippets.png "Menu with options for creating a new snippet file for Python, Quarto, or R")

    Menu with options for creating a new snippet file for Python, Quarto, or R

Although both RStudio and Positron keep track of custom snippets in a file, they don’t use the same syntax. Positron uses the TextMate syntax, which is inherited from VS Code. If you miss specific snippets from RStudio’s defaults, you can consult this file to see what they look like when translated to the syntax used by Positron: [`r.code-snippets`](https://github.com/posit-dev/ark/blob/19337a1b41e8c5a3a77ac61db93b7c6bf6cdc8a3/crates/ark/resources/snippets/r.code-snippets).
