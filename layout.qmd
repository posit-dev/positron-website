...
- The **Activity Bar** provides quick access to switch between core views such as Explorer, Search, [Source Control](git.qmd), and [Extensions](extensions.qmd), [Posit Publisher](extensions.qmd#included-extensions), and [Positron Assistant](assistant.qmd).
...
![Stacked default layout when viewing a Jupyter Notebook](images/layouts-default-stacked.png){width=50%}

- **Side-by-side**: Useful for wide-screen users or those who prefer their editor and console next to each other.

![Side-by-Side layout when viewing a Jupyter Notebook](images/layouts-side-by-side.png){width=50%}

- **Notebook**: Emphasizes the editor workspace for full focus on a Jupyter Notebook or source file, minimizing other panes.

![Notebook Layout when viewing a Jupyter Notebook](images/layouts-notebook.png){width=50%}
