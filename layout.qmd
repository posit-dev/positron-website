...
- The **Secondary Side Bar** is on the right by default. You can switch between the Session pane (where you can explore the [variables](variables-pane.qmd) you have defined and the [plots](plots-pane.qmd) you have created), the [Connections](connections-pane.qmd) pane, the [Help](help-pane.qmd) pane, and the Viewer pane.
