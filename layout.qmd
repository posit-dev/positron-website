---
title: "Layout"
description: "Customize your Positron workspace with flexible layout options. Choose from presets like Stacked, Side-by-side, Notebook, or Assistant to match your workflow."
---
...
- The **Secondary Side Bar** is on the right by default. You can switch between the **Session** pane (where you can explore the [variables](variables-pane.qmd) you have defined and the [plots](plots-pane.qmd) you have created), the [**Connections**](connections-pane.qmd) pane, the [**Help**](help-pane.qmd) pane, the **History** pane, and the **Viewer** pane.
...
- **Assistant**: Optimized for an Assistant-centric workflow, with easy access to [Positron Assistant](assistant.qmd) features alongside your code and console.

Use the _Customize Layout..._ command for more specific layout choices. You can also reset the whole UI back to defaults by clicking the {{<fa rotate-left >}} icon at the top right of the layout quickpick.
