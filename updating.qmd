...
description: "Keep Positron up to date with automatic monthly releases or opt into daily builds. Learn about update settings and Windows package manager options."
---
...
You can opt out of this automatic checking by changing the [`update.mode`](positron://settings/update.mode) setting to `"none"`; see [our page on privacy and data collection](privacy.qmd) for more details.
