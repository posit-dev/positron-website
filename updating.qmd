...
The Remote Extension Host (REH) also referred to as [Positron Server](https://positron.posit.co/remote-ssh.html) is updated automatically on the current monthly cadence when the Positron IDE/Client is updated.   
