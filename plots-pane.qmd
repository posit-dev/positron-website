...
{{< video videos/plots.mp4 aria-label="Video demonstration of the Plots Pane displaying and navigating visualizations from an R session" >}}

## Opening the Plots Pane

If the Plots Pane is not already displayed, you can access it via:

- Clicking **View** > **Plots** from the menu bar
- Running *Session: Focus on Plots View* from the [Command Palette](command-palette.qmd)
...
The Plots Pane can navigate to, copy, or rerun the code that created a plot. Click the {{< fa code >}} icon in the toolbar to access these actions.
