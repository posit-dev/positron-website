...
The **Plots** pane can navigate to, copy, or rerun the code that created a plot. Select the {{< fa code >}} icon in the toolbar to access these actions.
...
To pop the whole **Plots** pane UI to a separate auxiliary window, either run the command _Plots: Open Plots Gallery in New Window_ or select {{< fa regular window-maximize >}} from the **Plots** pane action bar.
